---
description: |
  TDD Red Phase specialist — use when starting a new test case or activating the next test from a test list.
  Launches as a subagent to guide through creating a failing test and making predictions.
mode: subagent
permission:
  edit: allow
  bash:
...
- ❌ Never call vitest directly — always use `npm test`
